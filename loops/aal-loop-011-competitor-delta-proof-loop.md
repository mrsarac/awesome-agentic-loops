...
example_receipt: examples/aal-loop-011-competitor-delta-proof-loop-receipt.md
status: proof-grade
---

# AAL-LOOP-011 — Competitor Delta Proof Loop
...
## Stopping condition
One public-ready card package exists with receipt and source map. Commit/push/publication is controlled by repository policy.
